/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cd45a111bcd59465a162c5568a5f7247)
...
interface __BaseEnv_Env {
	...
	STRIPE_PRICE_MEMBER_YEAR: string;
	STRIPE_PRICE_MEMBER_MONTH: string;
	STRIPE_PRICE_SUPPORTING_YEAR: string;
	STRIPE_PRICE_SUPPORTING_MONTH: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_DATABASE_ID: string;
	CLOUDFLARE_D1_TOKEN: string;
	BANK_IBAN: string;
	CRON_SECRET: string;
	HOLVI_API_BASE: string;
	HOLVI_API_KEY: string;
	HOLVI_POOL_HANDLE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "MAILGUN_API_KEY" | "BETTER_AUTH_SECRET" | "MASTODON_CLIENT_ID" | "MASTODON_CLIENT_SECRET" | "BOOTSTRAP_ROLES" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "STRIPE_PRICE_MEMBER_YEAR" | "STRIPE_PRICE_MEMBER_MONTH" | "STRIPE_PRICE_SUPPORTING_YEAR" | "STRIPE_PRICE_SUPPORTING_MONTH" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "BANK_IBAN" | "CRON_SECRET" | "HOLVI_API_BASE" | "HOLVI_API_KEY" | "HOLVI_POOL_HANDLE" | "MATRIX_BASE_URL" | "MATRIX_ACCESS_TOKEN" | "MATRIX_ROOM_ID">> {}
}
