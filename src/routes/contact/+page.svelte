...
<div class="people">
	{#each data.board as person (person.acct)}
		<div class="person">
			<img class="portrait" src="/board-avatar/{person.acct}" alt="" loading="lazy" />
			<h3>{person.displayName}</h3>
			<p class="muted small">{roleLabel(person.role)}</p>
			<p class="small contact-links">
				<a href="mailto:{person.email}">
					<svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"
						><path
							d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2Zm2-.5a.5.5 0 0 0-.5.5v.38l6.5 3.9 6.5-3.9V4a.5.5 0 0 0-.5-.5Zm12.5 2.63L8.77 9.53a1.5 1.5 0 0 1-1.54 0L1.5 6.13V12a.5.5 0 0 0 .5.5h12a.5.5 0 0 0 .5-.5Z"
						/></svg
					>
					{person.email}</a
				><br />
				<a href={person.url} rel="me">
					<svg
