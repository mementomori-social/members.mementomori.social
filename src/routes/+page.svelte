...
<p>
	...
	<a href="https://mementomori.social" rel="me">mementomori.social</a> social media platform,
	keeping it independent and member-supported.
</p>
...
<p class="muted small">
	ID <a
		...
		>3637371-4</a
	>, Jyväskylä, Finland, registered 6 July 2026
</p>

<h2>Membership</h2>

<p>
	The association is funded by its members. Using mementomori.social is free and open to
	everyone, and does not require membership. Membership is how the platform's costs get
	covered, and it comes with a say in how the association is run.
</p>
...
<p class="muted small">
	Fees are fixed and set by the association meeting. The monthly option is an instalment of
	the annual fee. Joining fee is 0 €, and membership is approved by the board.
</p>
...
<p>
	Running the platform costs <strong>{COSTS.monthlyEur} € a month</strong>
	({COSTS.description}), about {COSTS.annualEur} € a year. The association currently has
	{data.memberCount} approved {data.memberCount === 1 ? 'member' : 'members'}.
</p>
...
<p class="small">
	...
	<span class="muted">social media platform</span><br />
	<a href="https://help.mementomori.social">help.mementomori.social</a>
	<span class="muted">documentation</span><br />
	<a href="https://github.com/mementomori-social">github.com/mementomori-social</a>
	<span class="muted">open source</span>
</p>

<p class="contact muted small">
	Contact <a href="https://mementomori.social/@ry" rel="me">@ry@mementomori.social</a>
</p>
