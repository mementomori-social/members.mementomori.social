...
VALUES
	(lower(hex(randomblob(16))), NULL, '<FULL_NAME_CHAIR>', '<HOME_MUNICIPALITY>',
		'<EMAIL_ROLLE>', 'member', 'year', 'rolle', 0, 'approved', 1783242000, 1783242000),
	(lower(hex(randomblob(16))), NULL, '<FULL_NAME_SECRETARY>', '<HOME_MUNICIPALITY>',
		'<EMAIL_VEERA>', 'member', 'year', 'mustikkasoppa', 0, 'approved', 1783242000, 1783242000),
	(lower(hex(randomblob(16))), NULL, '<FULL_NAME_TREASURER>', '<HOME_MUNICIPALITY>',
